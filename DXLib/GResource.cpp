...
GResource::GResource(const D3D12_RESOURCE_DESC& resourceDesc, const std::wstring& name,
                     const D3D12_CLEAR_VALUE* clearValue, D3D12_RESOURCE_STATES initState,
...
GResource::GResource(ComPtr<ID3D12Resource>& resource, const std::wstring& name)
