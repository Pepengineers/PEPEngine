...
GMemory GHeap::Allocate(uint32_t numDescriptors)
{
	...
	return GMemory(
		CD3DX12_CPU_DESCRIPTOR_HANDLE(startCPUDescriptor, offset, descriptorHandleIncrementSize),
		CD3DX12_GPU_DESCRIPTOR_HANDLE(startGPUDescriptor, offset, descriptorHandleIncrementSize),
